        ...
        >
          ...
          <div className="space-y-4 md:space-y-6 mb-8 md:mb-12">
            <div className="flex items-center gap-4">
              <div className="w-6 h-6 bg-navy rounded-full flex items-center justify-center text-white shrink-0">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="w-full sm:w-auto bg-navy text-white px-8 md:px-10 py-3 md:py-4 rounded-full text-base md:text-lg font-bold shadow-xl flex items-center justify-center"
          >
