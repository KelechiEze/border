  ...
  return (
    <section className="py-16 md:py-24 bg-off-white">
      <div className="container mx-auto px-6">
        ...
        >
          <div className="absolute top-0 right-0 w-48 md:w-64 h-48 md:h-64 bg-lime/10 rounded-full -translate-y-1/2 translate-x-1/2" />
          <div className="absolute bottom-0 left-0 w-32 md:w-40 h-32 md:h-40 bg-lime/10 rounded-full translate-y-1/2 -translate-x-1/2" />
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-full sm:w-auto bg-lime text-primary px-8 md:px-10 py-3 md:py-4 rounded-full text-base md:text-lg font-bold shadow-xl"
              >
                Contact Us Now
              </motion.button>
              <motion.button
